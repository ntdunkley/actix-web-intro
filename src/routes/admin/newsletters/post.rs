...
const NEWSLETTER_PUBLISHED: &str = "The newsletter issue has been accepted - \
...
pub async fn publish_newsletter(
    ...
    let mut transaction = match idempotency::try_processing(&db_pool, &idempotency_key, *user_id)
        .await
